                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $monthly_income->expense_month }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{url('/expense_month_single')}}/{{$monthly_income->expense_month}}"
                                    class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i></a>
                                <a href="{{url('expense_month_delete')}}/{{ $monthly_income->expense_month }}"
